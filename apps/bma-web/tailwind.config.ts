  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "glow-navy": "radial-gradient(ellipse 60% 40% at 50% 0%, rgba(30,42,74,0.8), transparent)",
      },
      backgroundSize: {
        "grid-sm": "40px 40px",
        "grid-md": "60px 60px",
      ...
      boxShadow: {
        ...
        "card-hover": "0 2px 8px rgba(0,0,0,0.5), 0 8px 24px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.1)",
